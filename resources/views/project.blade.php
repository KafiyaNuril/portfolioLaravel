      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Oop</li>
              <li data-filter=".filter-card">Session</li>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/portfolio/Screenshot 2024-03-16 115512.png" class="img-fluid" alt="">
            <div class="portfolio-info">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/portfolio/Screenshot 2024-05-20 135819.png" class="img-fluid" alt="">
            <div class="portfolio-info">
